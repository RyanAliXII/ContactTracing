...
<div className="form-title org-form-title">
    ...
    <div className="input-wrapper org-input-wrapper">
                ...
                <input type="name" className="input signin-input bg1" name="org" onChange={handleOrgFormData} required></input>
            </div>
            <div className="btn-wrapper org-btn-wrapper">
                <button type="button" className="btn bl-bg default-clr" onClick={createOrg}>Create</button>
                <button type="button" className="btn bg1" onClick={closeCreateOrgForm}>Cancel</button>
            </div>
...
<div className="form-title org-form-title">
    ...
    <div className="input-wrapper org-input-wrapper">
                ...
                <input type="text" className="input signin-input bg1" name="username" onChange={handleScannerFormData} required></input>
            </div>
            <div className="input-wrapper org-input-wrapper">
                <label className="" htmlFor="password">Password</label>
                <input type="password" className="input signin-input bg1" name="password" onChange= {handleScannerFormData}required></input>
            </div>
            <div className="input-wrapper org-input-wrapper">
                            <label className="" htmlFor="org">Organization</label>
                            <select className="bg1" name="org" onChange={handleScannerFormData}>
            ...
            <div className="btn-wrapper org-btn-wrapper">
                ...
                <button type="button" className="btn bg1" onClick={closeScannerForm}>Cancel</button>
            </div>
